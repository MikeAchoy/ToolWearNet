...
def display_prediction(image_num, model, train_path, image_size, dpi=200):
    # Construct paths
    ...
    predicted_mask = cv2.resize(predicted_mask, (original_image.shape[1], original_image.shape[0]))  # Resize mask to original image size

    # Display the image and mask
    plt.figure(figsize=(10, 5), dpi=dpi)  # Increase the DPI for better resolution
